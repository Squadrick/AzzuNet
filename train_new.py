...
for learning_rate in learning_rates:
    for reg_rate in reg_rates: 
        ...
        train_writer = tf.summary.FileWriter('./new_logs_lr:%f,reg%f'%(learning_rate,reg_rate), sess.graph)
        val_writer = tf.summary.FileWriter('./new_logs_val_lr:%f,reg:%f'%(learning_rate, reg_rate), sess.graph)
        ...
        for i in range(epochs):
            ...
            if val_loss < min_loss:
                min_loss = val_loss
                print("Saving model...")
                saver.save(sess, "./models/NewAzzuNet-%f" % min_loss)
        ...
        saver.save(sess, "./models/new_final%f,%d"%(learning_rate, reg_rate))
